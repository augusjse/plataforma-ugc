...
export default function PeriodSelectorClient({ periodDays, from, to, compact = false }: { periodDays: number; from?: string; to?: string; compact?: boolean }) {
